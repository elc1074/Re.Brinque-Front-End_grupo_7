  ...
  return (
    <div className="flex w-full bg-[#EBEEEC] dark:bg-zinc-800 rounded-t-2xl p-6 gap-2 justify-center">
      <Link href="/tela-inicial">
        <Button className="text-white  flex items-center rounded-lg bg-primary h-12 w-28 text-lg">
          <Home className="!size-6"/>
          Início
        </Button>
      </Link>
      <Link href="/buscar">
        <Button className="text-white flex items-center rounded-lg bg-primary h-12 w-12">
