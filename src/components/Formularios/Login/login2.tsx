...
export default function LoginForm() {
  ...
  const handleGoogleLogin = () => {
    window.location.href =
      "https://back-rebrinque.onrender.com/api/auth/google";
  };
    ...
    <Card className="w-full max-w-md shadow-xl border-border/50 backdrop-blur-sm bg-card/95">
      ...
      <CardContent className="space-y-6">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full h-11 font-semibold hover:bg-primary/5 transition-all duration-300 hover:scale-[1.02] bg-transparent"
